...
EXPORTER_PORT = int(os.getenv('PORT', '5000'), 10)
SLEEP_TIME = 1
JORMUNGANDR_API = os.getenv('JORMUNGANDR_RESTAPI_URL',
                  os.getenv('JORMUNGANDR_API', 'http://127.0.0.1:4881/api'))
...
def process_jormungandr_metrics():
    ...
    metrics2 = jcli_rest(['stake-pool', 'get', 'b628a5f5e987b03151c232b80d59a17e214e7105258c5bf8fc734a55ceb3e8d5'])
    ...
    try:
       os.system('jcli rest v0 node stats get --host "http://127.0.0.1:4881/api" > nodestatsx')
    except:
        donothing=0
    ...
    try:
        epochstakecommand = "jcli rest v0 stake get --host " + "http://127.0.0.1:4881/api" + \
            " | grep -A 1 b628a5f5e987b03151c232b80d59a17e214e7105258c5bf8fc734a55ceb3e8d5 | sed -e 's/-//g' | sed -e 's/b628a5f5e987b03151c232b80d59a17e214e7105258c5bf8fc734a55ceb3e8d5//g' | sed -r '/^\s*$/d' | awk '{$1=$1;print}' > thisepochstake"
